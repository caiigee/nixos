  ...
  wayland.windowManager.hyprland =
    ...
    in
    {
      ...
      settings = {
        ...
        #
        #   "match:float,class:com.saivert.pwvucontrol"
        #   "match:float,class:gthumb"
        #   "match:float,class:xdg-desktop-portal-gtk"
        #   "match:float,class:clipse"
        #   "match:float,class:nmtui"
        #   "match:float,class:tweaks"
        #   "match:float,class:qt6ct"
        #   "match:float,class:blueman-manager"
        #   "match:float,class:org.gnome.Calendar"
        #   "match:float,class:org.gnome.FileRoller"
        #
        #   # Floating pop-ups:
        #   "match:float,class:firefox,initialTitle:^$"
        #   "match:float,class:firefox,initialTitle:^(Library)$"
        #   "match:float,class:^(\.blueman-manager-wrapped)$,initialTitle:^(Bluetooth Devices)$"
        #   "match:float,class:^(com\.github\.johnfactotum\.Foliate)$,initialTitle:^(Image from .+)$"
        #   "match:float,class:^(signal-desktop)$,title:^(Save File)$"
        #   "match:float,class:^(signal-desktop)$,title:^(Open Files)$"
        #   "match:float,class:^(file-.+)$,title:^(Export Image as .+)$"
        #
